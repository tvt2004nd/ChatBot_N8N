...
var require_middleware = __commonJS({
  ".next/server/middleware.js"() {
    "use strict";
    (self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[751], { 24: (a, b, c) => {
      "use strict";
      ...
      let g = c(24), h = { url: (a2) => a2.url, header: (a2, b2) => a2.headers.get(b2) };
...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `);
      ...
      let cn = ["/dashboard", "/profile", "/chat"];
      function co(a10) {
        var b10;
        let c2, { pathname: d2 } = a10.nextUrl;
        return cn.some((a11) => d2.startsWith(a11)) ? a10.cookies.get("auth_token")?.value ? ak.next() : ((c2 = new URL("/login", (b10 = a10).url)).searchParams.set("redirect", b10.nextUrl.pathname), ak.redirect(c2)) : ak.next();
      }
      let cp = { matcher: ["/dashboard/:path*", "/profile/:path*", "/chat/:path*"] };
      ...
      let cu = (a10) => bJ({ ...a10, IncrementalCache: cl, incrementalCacheHandler: null, page: cr, handler: async (...a11) => {
        try {
          return await cs(...a11);
        } catch (e2) {
...
var init_edgeFunctionHandler = __esm({
  "node_modules/@opennextjs/aws/dist/core/edgeFunctionHandler.js"() {
    ...
    globalThis._ROUTES = [{ "name": "middleware", "page": "/", "regex": ["^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/dashboard(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\.json|\\.rsc|\\.segments\\/.+\\.segment\\.rsc)?[\\/#\\?]?$", "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/profile(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\.json|\\.rsc|\\.segments\\/.+\\.segment\\.rsc)?[\\/#\\?]?$", "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/chat(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\.json|\\.rsc|\\.segments\\/.+\\.segment\\.rsc)?[\\/#\\?]?$"] }];
